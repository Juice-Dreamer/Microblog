...
class User(PaginatedAPIMixin, UserMixin, db.Model):  # 数据库表命是snake case 如user，GoodList-->good_list
    ...
    def to_dict(self, include_email=False):
        last_seen = self.last_seen.isoformat() + 'Z' if self.last_seen else 'no data'
